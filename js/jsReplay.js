                ...
                constructor.prototype = {
                    ...
                    */
                    "start": function() {
                        ...
                        // throw new Error("Cannot start playback -- browser window must match dimensions that the playback script was recorded in ("+$(window).width()+"px by "+$(window).height()+"px). Window is currently "+window.innerWidth+"px by "+window.innerHeight+"px.");
                        // return;
                        // }
...
var widgetTest = new jsReplay.playback("https://matthewpenkala.github.io/convert-hex-to-text/test.json");
widgetTest.start();


setTimeout(() => {
    console.log($("body > div > div.page.container > div.content > div.all-tools-container > div > div.body > div > div.side.output > div > div.side-wrapper > div.data-wrapper > textarea").val())
}, 999);
setTimeout(() => {
    console.log($("body > div > div.page.container > div.content > div.all-tools-container > div > div.body > div > div.side.output > div > div.side-wrapper > div.data-wrapper > textarea").val())
}, ((999 + 4999) / 2).toString());